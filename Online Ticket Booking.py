print("\n********************WELCOME TO TICKET NEW **********************")

acc = input("DO YOU HAVE TICKET NEW ACCOUNT:")
em=["ronaldo@gmail.com"]
if acc=='yes':
    email = input("\nENTER YOUR EMAIL ID:-")
    em.append(email)
    ph= input("\nENTER YOUR PHONE NO:")
...
movies=["vikram", "sitaramam", "sinam","beast"]
...
elif click_movie=="beast":
    total=beast_amount*seats
