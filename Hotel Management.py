class hotelmanagement:
    ...
    def roomrent(self):
        ...
        print ("1.  first class --AC >---->rs 6000 PN")

        print ("2.  first class --NON AC >---->rs 5000 PN")

        print ("3.  second class --AC >---->rs 4000 PN")

        print ("4.  second --NON AC >---->rs 3000 PN")
